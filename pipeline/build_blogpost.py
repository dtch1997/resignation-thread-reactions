...
**The short version.** Only 22% of posts engage the claim. 31% react, 25% judge the author (endorsement beats attack 18% to 7%), 22% are noise. Replies argue and quotes emote: argument, denial and attacks are 36% of replies but 12% of quotes. Among skeptics, most attack the messenger; the real cruxes are a small set of concrete gaps (mechanism, the off-switch, whether a token predictor can be an agent, base rates from past panics), each under 2% of posts. "If we stop, China wins" is the most common structured objection in the thread, and it concedes the danger while rejecting the response.
